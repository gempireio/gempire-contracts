...
/**
 * @dev {ERC1155} token, including ability for holders to burn (destroy) their tokens
 */
contract Founders is ERC1155 {
    ...
    constructor() {
        ...
        _mint(_msgSender(), 1, 8, "");
        _mint(_msgSender(), 2, 89, "");
        _mint(_msgSender(), 3, 987, "");
    }
     ...
     */
    modifier onlyAdmin() {
        require(admins[msg.sender], "Founders: caller is not Admin");
        _;
    }
